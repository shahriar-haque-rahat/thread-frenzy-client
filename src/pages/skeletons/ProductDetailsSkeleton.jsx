        ...
        <div className="px-[3%] mt-16 pb-32 animate-pulse">
            <div className="grid grid-cols-5 gap-5">
                ...
                <div className="col-span-3 grid grid-cols-2 grid-rows-2 gap-2 h-fit">
                    {[...Array(4)].map((_, index) => (
                        <div key={index} className="h-96 w-full bg-gray-300"></div>
                    ))}
                </div>
                ...
                <div className="col-span-2 space-y-6">
                    ...
                    <div className="flex gap-3 items-center">
                        <span>Sizes:</span>
                        {[...Array(3)].map((_, index) => (
                            <div key={index} className="h-10 w-12 bg-gray-300"></div>
                        ))}
                    </div>
            ...
            <div className="mt-20">
                <div className="h-10 w-64 bg-gray-300 mb-10"></div>
            ...
            <div className="border shadow-lg p-6 mt-10 space-y-6">
                <div className="h-10 w-48 bg-gray-300 mb-10"></div>
                <div className="space-y-4">
                    <div className="h-20 bg-gray-300"></div>
                    <div className="h-20 bg-gray-300"></div>
                    <div className="h-20 bg-gray-300"></div>
